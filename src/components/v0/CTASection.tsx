      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            <strong className="text-emerald-600">SolRenov</strong> gère tout votre projet de rénovation énergétique, du
            conseil à la pose, en passant par les aides et subventions.
            <br />
        ...
        >
          ...
          >
            ...
            <div>
              <div className="text-2xl mb-2">🚀 Demandez votre étude gratuite</div>
              <div className="text-emerald-200 text-sm font-normal">Bilan énergétique complet offert</div>
            </div>
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-3 border-orange-400 text-orange-600 hover:bg-orange-50 px-8 py-8 rounded-2xl text-xl font-bold transition-all duration-300 group h-auto flex-col gap-4 bg-white"
          >
            ...
            <div>
              ...
              <div className="text-orange-500 text-sm font-normal">Conseil personnalisé immédiat</div>
            </div>
          </Button>
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-3 border-emerald-400 text-emerald-600 hover:bg-emerald-50 px-8 py-8 rounded-2xl text-xl font-bold transition-all duration-300 group h-auto flex-col gap-4 bg-white"
          >
            <div>
              <div className="text-2xl mb-2">📍 Simulez vos aides en 2 minutes</div>
              <div className="text-emerald-500 text-sm font-normal">Calcul personnalisé gratuit</div>
            </div>
          </Button>
        </motion.div>
          ...
          <div className="bg-gradient-to-r from-gray-900 via-emerald-900 to-gray-900 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Rejoignez les milliers de propriétaires qui ont fait confiance à SolRenov pour leur transition
                énergétique
              </p>
