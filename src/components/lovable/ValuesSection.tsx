...
const ValuesSection = () => {
  ...
  return (
    <section
      id="valeurs"
      ref={sectionRef}
      className="py-20 px-6 bg-gradient-to-br from-green-900 to-green-800 relative overflow-hidden"
    >
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-green-100 max-w-3xl mx-auto leading-relaxed">
            SolRenov s'engage pour un habitat qui respecte l'environnement et
