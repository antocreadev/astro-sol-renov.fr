  ...
  const steps = [
    {
      ...
      detail:
        "Prise de contact immédiate, écoute de vos besoins, première évaluation de votre projet.",
    ...
    },
    {
      ...
      description: "(gratuit)",
      detail:
        "Diagnostic complet de votre habitation, identification des potentiels d'amélioration et simulation des aides disponibles.",
    ...
    },
    {
      ...
      detail:
        "Élaboration de votre projet unique, plans détaillés, choix des matériaux et technologies adaptées.",
    ...
    },
    {
      ...
      detail:
        "Mise en œuvre par nos équipes d'experts certifiés RGE, respect des délais et normes qualité.",
    ...
    },
    {
      ...
      detail:
        "Accompagnement continu, maintenance préventive et service après-vente disponible 24/7.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            🔒 Transparence totale – Zéro frais caché – Accompagnement
              ...
              >
                ...
                <div
                  className={`relative flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br ${
                    step.color
                  } flex items-center justify-center text-white shadow-lg z-10 transition-all duration-500 ${
                ...
                {/* Content */}
                <div
                  className={`flex-1 bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 border-l-4 ${
