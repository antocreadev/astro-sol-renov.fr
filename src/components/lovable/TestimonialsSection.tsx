...
const TestimonialsSection = () => {
  ...
  return (
    <section
      id="temoignages"
      ref={sectionRef}
      className="py-20 px-6 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden"
    >
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Découvrez les histoires réelles de nos clients et leurs
