...
import { Rocket, MessageCircle, MapPin, CheckCircle, Zap, Heart } from "lucide-react";
...
const CtaSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 px-6 bg-gradient-to-br from-green-600 via-green-700 to-orange-600 relative overflow-hidden">
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/30">
            ...
            <span className="text-white font-medium">Transformez votre habitat. Dès maintenant.</span>
          </div>
          ...
          <p className="text-2xl text-green-100 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            <br />
            SolRenov gère tout votre projet de rénovation énergétique, du conseil à la pose.
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-center mb-16">
            ...
            >
              ...
              ⚡ Je veux mon bilan énergétique gratuit
            </Button>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <h4 className="text-white font-bold text-lg mb-2">100% Gratuit & Sans Engagement</h4>
              <p className="text-green-100">Votre étude personnalisée offerte</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <Zap className="w-8 h-8 text-yellow-300 mx-auto mb-4" />
              <h4 className="text-white font-bold text-lg mb-2">Réponse Sous 24h</h4>
              <p className="text-green-100">Prise de contact express garantie</p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <CheckCircle className="w-8 h-8 text-green-300 mx-auto mb-4" />
              <h4 className="text-white font-bold text-lg mb-2">Certifié RGE</h4>
