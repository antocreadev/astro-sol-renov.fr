      ...
      <div className="max-w-7xl mx-auto">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-flex items-center gap-2 bg-red-50 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-red-600 font-medium">Section émotionnelle</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Chaque jour, des milliers de foyers comme le vôtre transforment leur quotidien.
            <br />
            <span className="font-semibold text-gray-800">Et vous ? Qu'attendez-vous ?</span>
          </p>
        </div>
        ...
        <div className={`bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl p-12 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-6 py-3">
            <span className="text-white">Le choix intelligent, c'est maintenant ⏰</span>
          </div>
        </div>
      </div>
    </section>
